...
<head>
    ...
    <title>SecurityForGeeks - Crypto -</title>
...
<div class="container text-center">
          ...
          <div class = "row">
          <div class= "col-md-4">
          <img src="images/Hardware-Cryptography-1068x601.jpg" class="img-fluid" data-toggle="modal" data-target="#video1">
          <img src="images/play.png" class="play-btn"  >
</div>
    <div class= "col-md-4">
    <img src="images/Hardware-Cryptography-1068x601.jpg" class="img-fluid" data-toggle="modal" data-target="#video2">
    <img src="images/play.png" class="play-btn"  >
</div>
   
<div class= "col-md-4">
    <img src="images/Hardware-Cryptography-1068x601.jpg" class="img-fluid" data-toggle="modal" data-target="#video3">
    <img src="images/play.png" class="play-btn"  >
          ...
          <div class="modal fade" id="video1">
              ...
              <div class="modal fade" id="video2">
                ...
                <div class="modal fade" id="video3">
                    ...
                    <div class="container text-center"
                    <font color = "white"><h2> Cryptography Training</h2></font>
                       <center><font color = "white"><h1><a href="latihancrypto.php"> Train yourself in here!</h1></font></center>
                    </div>
                              ...
                              <div class="footer_content">
                                  <div class="row">
                                      ...
                                      <div class="col-lg-3 footer_col">
                                          ...
                                          style="color:white"
                                           >Just a Cyber Security Learning Platform. We learn and contribute to Cyber Security Industries </p>
