...
<head>
    ...
    <title>SecurityForGeeks - SWP -</title>
...
<div class="container text-center">
          ...
          <div class = "row">
          <div class= "col-md-4">
          <img src="images/web-development-minimalism-bl.jpg" class="img-fluid" data-toggle="modal" data-target="#video1">
          <img src="images/play.png" class="play-btn"  >
</div>
    <div class= "col-md-4">
    <img src="images/web-development-minimalism-bl.jpg" class="img-fluid" data-toggle="modal" data-target="#video2">
    <img src="images/play.png" class="play-btn"  >
</div>
   
<div class= "col-md-4">
    <img src="images/web-development-minimalism-bl.jpg" class="img-fluid" data-toggle="modal" data-target="#video3">
    <img src="images/play.png" class="play-btn"  >
...
<div class="modal fade" id="video2">
  ...
  <div class="modal fade" id="video3">
      ...
      <div class="container text-center"
                    <font color = "white"><h2> Secure Web Programming</h2></font>
                       <center><font color = "white"><h1><a href="latihanswp.php"> Train yourself in here!</h1></font></center>
                    </div>
