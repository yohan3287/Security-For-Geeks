...
<html lang="en">
<head>
<title>SecurityForGeeks - About Us -</title>
<meta charset="utf-8">
...
<div class="super_container">
		...
		<div class="container">
			<div class="row row-eq-height">
				...
				<div class="col-lg-6 order-2 order-lg-1">
					...
					<p class="become_text"> This web is developed for SLME & Software Engineering Project. <br> We created a platform to sell Courses for those who interested and wants to learn more about cyber security from scratch and in a structurized way
	...
	<!-- Teachers -->
<center><b><strong><font size="48" color="black">Developer Team</font></strong></b></center>
				...
				<div class="col-lg-4 teacher">
					<div class="card">
						...
						<div class="card-body text-center">
							...
							<div class="card-text">Peneration Testing</div>
				...
				<div class="col-lg-4 teacher">
					<div class="card">
						...
						<div class="card-body text-center">
							...
							<div class="card-text">Developer Front-End</div>
							<div class="teacher_social">
								<ul class="menu_social">
									<li class="menu_social_item"><a href="#"><i class="fab fa-pinterest"></i></a></li>
									<li class="menu_social_item"><a href="#"><i class="fab fa-linkedin-in"></i></a></li>
				...
				<div class="col-lg-4 teacher">
					<div class="card">
						...
						<div class="card-body text-center">
							...
							<div class="card-text">Leader</div>
							<div class="teacher_social">
								<ul class="menu_social">
									<li class="menu_social_item"><a href="#"><i class="fab fa-pinterest"></i></a></li>
				...
				<div class="col-lg-4 teacher">
					<div class="card">
						...
						<div class="card-body text-center">
							...
							<div class="card-text">Developer Back-End</div>
							<div class="teacher_social">
								<ul class="menu_social">
									<li class="menu_social_item"><a href="#"><i class="fab fa-pinterest"></i></a></li>
									<li class="menu_social_item"><a href="#"><i class="fab fa-linkedin-in"></i></a></li>
