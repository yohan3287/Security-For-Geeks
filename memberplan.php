...
<html lang="en">
<head>
<title>SecurityForGeeks - Membership -</title>
<meta charset="utf-8">
			...
			<div class="row">
				<div class="col">
					<div class="section_title text-center">
						<h1>Pick your membership plan</h1>
					</div>
				</div>
			</div>
			...
			<div class="row course_boxes">
				...
				<div class="col-lg-4 course_box">
					<div class="card">
						...
						<div class="card-body text-center">
							<div class="card-title"><a href="payment.php?packet=Basic%20to%20intermediate">Basic to Intermediate</a></div>
							<div class="card-text">Package Includes basic to Medium level courses and Unlock E-certificate after completion of a course <br><br> IDR 1.000.000 <br></div>
							<div class="news_post_button text-center trans_200">
									<a href="payment.php?packet=Basic%20to%20intermediate"><b>Buy Now</b></a>
							</div>
						</div>
				...
				<div class="col-lg-4 course_box">
					<div class="card">
						...
						<div class="card-body text-center">
							<div class="card-title"><a href="payment.php?packet=Basic%20to%20expertise">Basic to Expertise</a></div>
							<div class="card-text">Package Includes basic to Expert level courses and Unlock E-certificate after completion of a course <br><br><br> IDR 1.500.000<br> </div>
							<div class="news_post_button text-center trans_200">
									<a href="payment.php?packet=Basic%20to%20expertise"><b>Buy Now</b></a>
